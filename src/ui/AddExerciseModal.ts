...
import { Exercise, MUSCLE_GROUPS, EQUIPMENT_TYPES } from "../types";
...
export class AddExerciseModal extends Modal {
  ...
  constructor(app: App, _settings: unknown, exerciseLibrary: ExerciseLibrary, onSave: () => void) {
    super(app);
  ...
  onOpen() {
    ...
    // Primary Muscles
    new Setting(contentEl).setName("Primary Muscles").setDesc("Main muscles targeted");
    ...
    // Secondary Muscles
    new Setting(contentEl).setName("Secondary Muscles").setDesc("Supporting muscles");
    ...
    // Type
    new Setting(contentEl).setName("Exercise Type").addDropdown((dropdown) => {
    ...
    // Equipment
    new Setting(contentEl).setName("Equipment").addDropdown((dropdown) => {
    ...
    // Description
    new Setting(contentEl).setName("Description").setDesc("How to perform the exercise (optional)");
